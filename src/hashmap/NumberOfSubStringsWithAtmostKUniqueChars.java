...
public class NumberOfSubStringsWithAtmostKUniqueChars {

    public static void main(String[] args) {
        Scanner sc = new Scanner( System.in);
        String str = sc.nextLine();
        int k = sc.nextInt();
        System.out.println( numberOfSubStringsWithAtmostKUniqueChars( str, k));
    }

    private static int numberOfSubStringsWithAtmostKUniqueChars(String str, int k) {
